...
const MainHeader: React.FC = () => {
  return (
    <header className="fixed w-full bg-indigo-700 shadow">
      <div className="max-w-lg m-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link href="/search">
          <a className="ml-4 flex-1 max-w-sm relative">
            <input type="text" placeholder={'Coba cari "PKM"'} className="rounded-full w-full pl-4 pr-8 py-2 text-xs transition bg-indigo-300 text-indigo-900 placeholder-indigo-900 hover:bg-white" />
